...
counterEl.classList.remove('counter--limit');
  ...
  // reset counter title
counterTitleEl.textContent = 'Numeric Counter';
...
const currentValueAsNumber = +currentValue;
  ...
  // decrement by 1
let newValue = currentValueAsNumber - 2;

  // check if new value is less than -10
if (newValue < -10) {
    // if it is, force it to be -10 instead
    newValue = -10;

counterEl.classList.add('counter--limit');

counterTitleEl.innerHTML = "Limit!.<b>buy Pro version</b> for <-10";
}
